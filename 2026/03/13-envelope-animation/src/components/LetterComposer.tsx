...
// Step timeline:
// 0 = composing    (letter above, user typing)
// 1 = descending   (letter slides into envelope)
// 2 = sealing      (flap closes)
...
export function LetterComposer() {
  ...
  useEffect(() => {
    const timings: Record<number, number> = {
      1: 1000, // letter descent duration
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* Send Button — P4: AnimatePresence for exit transition */}
                  <AnimatePresence>
                    {step === 0 && (
                      <motion.button
              ...
              {/* TOP FLAP — P3: z-index animates with step */}
              <motion.div
